...
// Cargos que têm acesso à tela de Funcionários
const CARGOS_ADMIN = ['Gerente', 'Administrador'];
...
export default function Home() {
  ...
  const podeVerFuncionarios = usuario?.cargo
    ? CARGOS_ADMIN.includes(usuario.cargo)
    : false;
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          <View>
            <Text style={styles.titulo}>Panna</Text>
      ...
      <View style={styles.menuContainer}>
        ...
        {/* Funcionários: só visível para Gerente e Administrador */}
        {podeVerFuncionarios && (
          <TouchableOpacity
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>Panna - Gerenciamento de Padaria</Text>
      </View>
    </ScrollView>
  );
}
